...
const Domoticz = require('./lib/domoticz').Domoticz;
const Mqtt = require('./lib/mqtt').Mqtt;
...
eDomoticzBasePlatform = {
    setupMqttConnection: function(platform) { // Setup the static MQTT client (shared) instance.
