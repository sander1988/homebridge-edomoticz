...
Helper.createCustomCharacteristic = function (displayName, uuid, props) {
    var characteristic = function () {
        Characteristic.call(this, displayName, uuid);
        this.setProps(props);
        this.value = this.getDefaultValue();
    };
    characteristic.displayName = displayName;
    characteristic.UUID = uuid;
    Helper.fixInheritance(characteristic, Characteristic);
    return characteristic;
};

Helper.createCustomService = function (uuid, characteristics, optionalCharacteristics) {
    var service = function (displayName, subtype) {
        ...
        if (optionalCharacteristics) {
            for (var characteristic of optionalCharacteristics) {
                this.addOptionalCharacteristic(characteristic);
            }
        }
    };
    service.UUID = uuid;
    Helper.fixInheritance(service, Service);
    return service;
};
