...
const eDomoticzServices = require('./services').eDomoticzServices;
        ...
        Domoticz.deviceStatus(this, function (json) {
            ...
            sArray.map(function (s) {
                try {
                    ...
                    this.platform.log(this.name + '(WW Light): This device does not comply to Domoticz lighting standard for a WW light. Ignoring "Color" and setting White.');
                    value = 140;
                }
            }.bind(this));
            ...
            case this.swTypeVal == Constants.DeviceTypeDimmer:
                {
                    ...
                    if (isFan) {
                        ...
                        if (this.subType == "RGBW" || this.subType == "RGBWW" || this.subType == "RGBWWZ" || this.subType == "RGB" ) {
                            ...
                            //} else {
                            //    this.platform.log(this.name +' claims to be a WW light but provides no Color object. Treating as plain old Dimmer.');
                            //}
                        }
                    }
                    this.services.push(service);
...
Helper.fixInheritance(eDomoticzAccessory, eDomoticzBaseAccessory);
